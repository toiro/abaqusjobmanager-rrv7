 ...
 */
export function createJobEvent<T = unknown>(
	type: string,
	data?: T,
): SSEEvent<T> {
...
export function createFileEvent<T = unknown>(
	type: string,
	data?: T,
): SSEEvent<T> {
...
export function createNodeEvent<T = unknown>(
	type: string,
	data?: T,
): SSEEvent<T> {
...
export function createUserEvent<T = unknown>(
	type: string,
	data?: T,
): SSEEvent<T> {
...
export function createSystemEvent<T = unknown>(
	type: string,
	data?: T,
): SSEEvent<T> {
 ...
 */
export function createTypedJobEvent(
	type: string,
	data?: JobEventData,
): SSEEvent<JobEventData> {
	return createJobEvent(type, data);
}

export function createTypedFileEvent(
	type: string,
	data?: FileEventData,
): SSEEvent<FileEventData> {
	return createFileEvent(type, data);
}

export function createTypedNodeEvent(
	type: string,
	data?: NodeEventData,
): SSEEvent<NodeEventData> {
	return createNodeEvent(type, data);
}

export function createTypedUserEvent(
	type: string,
	data?: UserEventData,
): SSEEvent<UserEventData> {
	return createUserEvent(type, data);
}

export function createTypedSystemEvent(
	type: string,
	data?: SystemEventData,
): SSEEvent<SystemEventData> {
