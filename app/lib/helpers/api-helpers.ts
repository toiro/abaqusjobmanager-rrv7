...
export const httpError = {
  badRequest: (message = 'Bad Request', details?: unknown) => error(message, details, 400),
  ...
  conflict: (message = 'Conflict', details?: unknown) => error(message, details, 409),
  validation: (message = 'Validation Error', details?: unknown) => error(message, details, 422),
  serverError: (message = 'Internal Server Error', details?: unknown) => error(message, details, 500)
};
