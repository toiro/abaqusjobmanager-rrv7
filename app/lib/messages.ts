...
export const ERROR_MESSAGES = {
	...
	INSUFFICIENT_NODE_LICENSE:
		"Not enough license tokens available on selected node",
	INSUFFICIENT_SYSTEM_LICENSE:
...
export const VALIDATION_MESSAGES = {
	...
	ONLY_COMPLETED_FAILED_MISSING_DELETABLE:
		"Only completed, failed, or missing jobs can be deleted",
	ONLY_WAITING_STARTING_RUNNING_CANCELLABLE:
		"Only waiting, starting, or running jobs can be cancelled",
} as const;
...
export const INFO_MESSAGES = {
	...
	CANCEL_RUNNING_JOB_WARNING:
		"Warning: This will forcefully terminate the running job",
} as const;
