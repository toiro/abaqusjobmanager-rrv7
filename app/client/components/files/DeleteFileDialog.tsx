...
import { BaseDialog } from "~/client/components/shared/BaseDialog";
import type { BaseDialogConfig } from "~/client/components/shared/BaseDialog";
				...
				>
					<div className="flex items-center">
						<div className="flex-shrink-0">
							<svg
								className={`h-4 w-4 ${
									file.referencingJob ? "text-red-400" : "text-yellow-400"
								}`}
								fill="currentColor"
								viewBox="0 0 20 20"
							>
						...
						<div className="ml-3">
							<p
								className={`text-sm ${
									file.referencingJob ? "text-red-800" : "text-yellow-800"
								}`}
							>
								<strong>Warning:</strong>{" "}
								{file.referencingJob
									? `This file is actively referenced by a job (${file.referencingJob.jobName}). Deleting it will affect the job and may cause execution failures.`
