		...
		<div className={`border-b bg-muted/5 ${className}`}>
			<div className="container mx-auto px-4 py-2">
				<div className="flex items-center justify-between text-sm">
					{/* Dynamic SSE Status */}
					<div
						className={`flex items-center space-x-3 px-3 py-1 rounded-md border ${sseConfig.bgColor}`}
					>
					...
					<div
						className={`flex items-center space-x-3 px-3 py-1 rounded-md ${licenseConfig.bgColor}`}
					>
						<svg
