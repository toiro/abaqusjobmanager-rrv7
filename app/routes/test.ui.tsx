    ...
    >
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>Real-time SSE connection and license status indicators</CardDescription>
        </CardHeader>
        <CardContent>
          <SystemStatusBar 
            initialLicenseUsed={8}
            initialLicenseTotal={12}
          />
          <div className="mt-4 text-sm space-y-2">
            <p>The SystemStatusBar shows:</p>
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li><strong>SSE Connection Status</strong>: Real-time connection indicator with auto-reconnection</li>
              <li><strong>License Usage</strong>: Current Abaqus license token usage (8/12 in this example)</li>
              <li><strong>Hydration-Safe</strong>: Server-side renders static content, client-side shows dynamic updates</li>
              <li><strong>Connection States</strong>: Connected (green), Connecting (yellow), Error (orange), Disconnected (red)</li>
            </ul>
          </div>
        </CardContent>
      </Card>
