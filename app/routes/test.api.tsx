			...
			<div className="space-y-8">
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Build and send API requests to test endpoints
						</CardDescription>
					</CardHeader>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							List of available API endpoints for testing
						</CardDescription>
					</CardHeader>
					<CardContent>
					...
					<CardContent>
						<div className="text-sm space-y-2">
							...
							<ul className="list-disc list-inside ml-4 space-y-1">
								<li>
									Select an endpoint from the dropdown or click "Select" next to
									an endpoint below
								</li>
								<li>Choose the appropriate HTTP method</li>
								<li>
									For POST/PUT requests, provide JSON request body if needed
								</li>
							...
							<div className="bg-muted p-3 rounded-lg font-mono text-xs">
								...
								<pre>
									{"{"}"eventType": "license_usage_updated", "data": {"{"}
									"totalTokens": 50, "usedTokens": 25, "availableTokens": 25
									{"}"}
									{"}"}
									{"}"}
								</pre>
								...
								<pre>
									{"{"}"name": "Test Job", "cpu_cores": 4, "priority": "normal"
									{"}"}
								</pre>
							</div>
						</div>
