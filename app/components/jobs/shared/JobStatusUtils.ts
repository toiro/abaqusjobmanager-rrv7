...
export const JobStatusConfig = {
   ...
   */
  getBadgeVariant: (status: JobStatus): "secondary" | "destructive" | "default" | "warning" | "waiting" | "running" | "success" | "outline" => {
    const variants: Record<JobStatus, "secondary" | "destructive" | "default" | "warning" | "waiting" | "running" | "success" | "outline"> = {
      'waiting': 'waiting',
      'starting': 'warning', 
      'running': 'running',
      'completed': 'success',
