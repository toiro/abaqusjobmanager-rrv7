...
import { BUTTONS, PLACEHOLDERS, PRIORITY_LEVELS, INFO_MESSAGES, FORM_LABELS } from "~/lib/messages";
import type { User, Node, Job } from "~/lib/core/types/database";
import { 
  UserSelectionField, 
  NodeSelectionField, 
  CpuCoresField, 
...
import { useJobCreateSubmission, useJobEditSubmission } from "./shared/useFormSubmission";
import { removeFileExtension } from "~/utils/formatting";
      ...
      <DialogContent className="sm:max-w-md">
        ...
        >
          ...
          <DialogFooter>
            ...
            >
              {isSubmitting ? modalConfig.submittingButton : modalConfig.submitButton}
            </Button>
          </DialogFooter>
        </Form>
      </DialogContent>
