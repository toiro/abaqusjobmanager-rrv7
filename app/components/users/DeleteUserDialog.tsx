        ...
        <div className="space-y-4">
          ...
          <Alert>
            <AlertDescription>
              <div className="space-y-1">
                <p><strong>User Name:</strong> {user.display_name}</p>
                <p><strong>User ID:</strong> {user.id}</p>
                <p><strong>Max Concurrent Jobs:</strong> {user.max_concurrent_jobs}</p>
          ...
          {hasActiveJobs && (
            <Alert variant="destructive">
              <AlertDescription>
                This user has active jobs running. Please wait for jobs to complete or cancel them before deletion.
              </AlertDescription>
            </Alert>
          )}
          ...
          <Alert variant="destructive">
            <AlertDescription>
              <strong>Warning:</strong> This action cannot be undone. All job history associated with this user will remain but will show as "Unknown User".
            </AlertDescription>
          </Alert>
          ...
          {actionData?.success && (
            <Alert>
              <AlertDescription>
                {typeof actionData.success === 'string' ? actionData.success : 'User deleted successfully'}
              </AlertDescription>
            </Alert>
          )}
        </div>
